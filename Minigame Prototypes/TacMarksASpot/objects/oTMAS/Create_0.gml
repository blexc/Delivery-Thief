...
color_id = instance_find(oTMASColor, irandom_range(0, instance_number(oTMASColor)-1));
shake_id = instance_find(oTMASShake, irandom_range(0, instance_number(oTMASShake)-1));